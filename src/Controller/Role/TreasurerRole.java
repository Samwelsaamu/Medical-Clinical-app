...
import gui.TreasurerRole.TreasurerWorkerjPanel;
...
//
    public TreasurerRole(){
        this.type = Role.RoleType.Treasurer;
    }
    @Override
    public JPanel createWorkArea(JPanel userLoginContainer,JPanel container, Users account, Department department, Enterprise enterprise, HealthNGO system) {
        return new TreasurerWorkerjPanel(userLoginContainer,container,enterprise,department,account, system);
    }
}
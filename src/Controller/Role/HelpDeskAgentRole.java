...
import gui.HDARole.HelpDeskAgentWorkerjPanel;
...
public class HelpDeskAgentRole extends Role{
//
    public HelpDeskAgentRole(){
        this.type = Role.RoleType.HelpDeskAgent;
    }
    @Override
    public JPanel createWorkArea(JPanel userLoginContainer,JPanel container, Users account, Department department, Enterprise enterprise, HealthNGO system) {
        return new HelpDeskAgentWorkerjPanel(userLoginContainer,container,enterprise,department,account, system);
    }
}
...
import gui.BillingAgentRole.BillingAgentRoleWorkerjPanel;
...
public class BillingAgentRole extends Role{
//
    public BillingAgentRole(){
        this.type = Role.RoleType.BillingAgent;
    }
    @Override
    public JPanel createWorkArea(JPanel userLoginContainer,JPanel container, Users account, Department department, Enterprise enterprise, HealthNGO system) {
        return new BillingAgentRoleWorkerjPanel(userLoginContainer,container,enterprise,department,account, system);
    }
}
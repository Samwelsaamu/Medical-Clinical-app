...
public class TreasurerWorkerjPanel extends javax.swing.JPanel {
    ...
    public TreasurerWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void fundsRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fundsRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.FundsRequestWorker")){
            ...
            TreasurerWorkerFundsRequestjPanel fundsProcess=new TreasurerWorkerFundsRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,funds);

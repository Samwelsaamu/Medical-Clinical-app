...
public class BillingAgentRoleWorkerjPanel extends javax.swing.JPanel {
    ...
    public BillingAgentRoleWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(networknamejLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 421, Short.MAX_VALUE)
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        DischargePatientRequest request =(DischargePatientRequest)previousRequestsjTable.getValueAt(selectedRow, 0);
        
        BillingAgentWorkerProcessSuicideRequestjPanel billingagentsuicideIdeationProcess=new BillingAgentWorkerProcessSuicideRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,request);
        CardLayout layout=(CardLayout)container.getLayout();
        container.add("billingagentsuicideIdeationProcess",billingagentsuicideIdeationProcess);
    ...
    public void previousRequets(){
        ...
        for (WorkRequest order : org.getWorkQueue().getWorkRequestList()){
            ...
            if(request.contains("Controller.WorkQueue.DischargePatientRequest")){
                row[0] = order;
                row[1] = (order.getSender()!=null)?order.getSender():"";
                row[2] = order.getStatus();
                row[3] = order.getMessage();
                row[4] = order.getRequestDate();
                String result = ((DischargePatientRequest)order).getRequesteResult();

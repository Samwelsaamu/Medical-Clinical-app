...
public class ProcessManagerWorkerItemsReqestjPanel extends javax.swing.JPanel {
    ...
    private ItemsRequestWorker itemsRequest;
    public ProcessManagerWorkerItemsReqestjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise, Users user, HealthNGO system,ItemsRequestWorker itemsRequest) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Resolve Item Requested", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Items Request", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));

        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Item Message"));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(itemQuantityjLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void submitjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitjButtonActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Quantity Must be a Positive Integer Number.", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        int confirm=JOptionPane.showConfirmDialog(null, "Do You Want to Resolve this Item Request?", "Resolve Items Request", JOptionPane.YES_NO_OPTION);
        if(confirm==0){
            itemsRequest.setRequesteResult(message);
            itemsRequest.setStatus("Request Processed");
            itemsRequest.setResolvedQty(qty);
//            resoveItemResultjTextArea.setText("");
            resoveItemResultjTextArea.setEditable(false);
            submitjButton.setVisible(false);
            JOptionPane.showMessageDialog(null, "Item Request Resolved.");
    ...
    public void displayItemRequest(){
        this.itemQuantityjLabel.setText(String.valueOf(itemsRequest.getQuantity()));
        this.itemsstatusLabel.setText(itemsRequest.getStatus());
        this.requestIssuejTextArea.setText(itemsRequest.getMessage());
        if(this.itemsRequest.getRequesteResult()!=null){
            resoveItemResultjTextArea.setText(itemsRequest.getRequesteResult());
            resoveItemResultjTextArea.setEditable(false);
            submitjButton.setVisible(false);
            itemQtyjTextField.setEditable(false);
            itemQtyjTextField.setText(String.valueOf(itemsRequest.getResolvedQty()));
        }
        else{
            resoveItemResultjTextArea.setText("");

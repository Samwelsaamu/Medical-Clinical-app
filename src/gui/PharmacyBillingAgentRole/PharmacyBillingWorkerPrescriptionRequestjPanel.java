 ...
 */
package gui.PharmacyBillingAgentRole;
...
import Controller.WorkQueue.BillingWorker;
...
public class PharmacyBillingWorkerPrescriptionRequestjPanel extends javax.swing.JPanel {
    ...
    private Department org,pharmacybillingOrg,financeOrg;
    ...
    public PharmacyBillingWorkerPrescriptionRequestjPanel(JPanel logincontainerJPanel,JPanel container, Users user, HealthNGO system,PatientMedicineRequest patientMedicines) {
        initComponents();
        this.system=system;
        ...
        this.billingW=patientRequest.getBillingW();
    ...
    private void initComponents() {
        ...
        billingNotejTextArea = new javax.swing.JTextArea();
        ...
        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder("Bill Notes and Description"));

        billingNotejTextArea.setColumns(20);
        billingNotejTextArea.setRows(5);
        jScrollPane2.setViewportView(billingNotejTextArea);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(medicineqtyjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(downloadjButton, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PharmacyBillingAgentRoleWorkerjPanel dwjp = (PharmacyBillingAgentRoleWorkerjPanel) component;
    ...
    private void submitBilljButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBilljButtonActionPerformed
        String message = billingNotejTextArea.getText().trim();
        ...
        int confirm=JOptionPane.showConfirmDialog(null, "Do You Want to Send patient bill to Finance?", "Create Bill Patient", JOptionPane.YES_NO_OPTION);
        if(confirm==0){
            billingW = new BillingWorker();
            billingW.setMessage(String.valueOf(bill));
            billingW.setRequesteResult(message);
            billingW.setSender(user);
            billingW.setStatus("Bill Sent to Finance");
            billingW.setWorkOrderR(patientRequest);
            billingW.setPrecriptionNotesW(prescriptionNotesW);
            patientRequest.setBillingW(billingW);
            prescriptionNotesW.setBillingW(billingW);
            ...
            financeOrg.getWorkQueue().getWorkRequestList().add(billingW);

//            user.getWorkQueue().getWorkRequestList().add(billingW);
            billingNotejTextArea.setText("");
    ...
    public void displayPatient(){
        ...
        this.patientPrescriptionsjTextArea.setText(prescriptionNotesW.getMessage());
        if(billingW!=null){
            this.submitBilljButton.setVisible(false);
            this.billingNotejTextArea.setEditable(false);
            this.billAmountjTextField.setEditable(false);
            this.billingNotejTextArea.setText(billingW.getRequesteResult());
            this.billAmountjTextField.setText(billingW.getMessage());
        }
        else{
    ...
    private javax.swing.JTextArea billingNotejTextArea;

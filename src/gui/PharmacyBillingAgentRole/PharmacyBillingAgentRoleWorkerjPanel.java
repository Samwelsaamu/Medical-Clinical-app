...
public class PharmacyBillingAgentRoleWorkerjPanel extends javax.swing.JPanel {
    ...
    public PharmacyBillingAgentRoleWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.PatientMedicineRequest")){
            ...
            PharmacyBillingWorkerPrescriptionRequestjPanel medicineRProcess=new PharmacyBillingWorkerPrescriptionRequestjPanel(logincontainerJPanel,container, user ,system,request);

...
import gui.EmergencyMedicineDoctorRole.EmergencyMedicineDoctorRoleWorkerjPanel;
...
public class MedicalJPanel extends javax.swing.JPanel {
    ...
    public MedicalJPanel(JPanel logincontainerJPanel,JPanel container, HealthNGO system) {
        initComponents();
        String networkname="Medical Login";
        for(Network network:system.getNetworkList()){
            networkname=network.getName()+" "+"Medical Login";
        }
    ...
    private void initComponents() {
        ...
        loginjPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Medical Login Only", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        loginjPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, loginjPanelLayout.createSequentialGroup()
                ...
                .addGroup(loginjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(passjPasswordField, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
    ...
    private void loginjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginjButtonActionPerformed
        ...
        if(user==null){
            ...
            boolean isFoundDoctor=system.getUsersDirectory().checkIfUsernameIsPsychiastrist(user.getRole().toString());
            boolean isFoundBillingAgent=system.getUsersDirectory().checkIfUsernameIsBillingAgent(user.getRole().toString());
            boolean isFoundNurse=system.getUsersDirectory().checkIfUsernameIsNurse(user.getRole().toString());
            boolean isFoundVehicleDri=system.getUsersDirectory().checkIfUsernameIsEmergencyVehicleDriver(user.getRole().toString());
            boolean isFoundMedDoctor=system.getUsersDirectory().checkIfUsernameIsEmergencyMedicineDoc(user.getRole().toString());
            boolean isFoundCriticalCare=system.getUsersDirectory().checkIfUsernameIsCriticalCare(user.getRole().toString());
   
            if(isFoundDoctor){
                PsychiatristRoleWorkerjPanel adminAssistanceWorkAreaJPanel=new PsychiatristRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("adminAssistanceWorkAreaJPanel",adminAssistanceWorkAreaJPanel);
                CardLayout layout=(CardLayout)container.getLayout();
                layout.next(container);
            }
            else if(isFoundBillingAgent){
                BillingAgentRoleWorkerjPanel adminAssistanceWorkAreaJPanel=new BillingAgentRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("adminAssistanceWorkAreaJPanel",adminAssistanceWorkAreaJPanel);
                CardLayout layout=(CardLayout)container.getLayout();
                layout.next(container);
            }
            else if(isFoundNurse){
                NurseRoleWorkerjPanel adminAssistanceWorkAreaJPanel=new NurseRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("adminAssistanceWorkAreaJPanel",adminAssistanceWorkAreaJPanel);
                CardLayout layout=(CardLayout)container.getLayout();
                layout.next(container);
            }
            else if(isFoundVehicleDri){
                EmergencyVehicleDriverRoleWorkerjPanel adminAssistanceWorkAreaJPanel=new EmergencyVehicleDriverRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("adminAssistanceWorkAreaJPanel",adminAssistanceWorkAreaJPanel);
                CardLayout layout=(CardLayout)container.getLayout();
                layout.next(container);
            }
            else if(isFoundMedDoctor){
                EmergencyMedicineDoctorRoleWorkerjPanel adminAssistanceWorkAreaJPanel=new EmergencyMedicineDoctorRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("adminAssistanceWorkAreaJPanel",adminAssistanceWorkAreaJPanel);
                CardLayout layout=(CardLayout)container.getLayout();
                layout.next(container);
            }
            else if(isFoundCriticalCare){
                CriticalCareManagerRoleWorkerjPanel adminAssistanceWorkAreaJPanel=new CriticalCareManagerRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("adminAssistanceWorkAreaJPanel",adminAssistanceWorkAreaJPanel);
                CardLayout layout=(CardLayout)container.getLayout();
                layout.next(container);

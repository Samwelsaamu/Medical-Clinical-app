...
public class RehabCenterJPanel extends javax.swing.JPanel {
    ...
    public RehabCenterJPanel(JPanel logincontainerJPanel,JPanel container, HealthNGO system) {
        initComponents();
        String networkname="Rehab Center Login";
        for(Network network:system.getNetworkList()){
            networkname=network.getName()+" "+"Rehab Center Login";
        }
    ...
    private void initComponents() {
        ...
        loginjPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Rehab Center Login Only", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        jLabel3.setText("Login to receive life Rehab Issues from MHW");
    ...
    private void loginjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginjButtonActionPerformed
        ...
        if(user==null){
            ...
            boolean isFound=system.getUsersDirectory().checkIfUsernameIsRehabDoctorRole(user.getRole().toString());
            if(isFound){
                RehabDoctorRoleWorkerjPanel rehabCenterDoctorJPanel=new RehabDoctorRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("rehabCenterDoctorJPanel",rehabCenterDoctorJPanel);

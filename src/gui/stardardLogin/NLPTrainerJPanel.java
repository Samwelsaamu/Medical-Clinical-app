...
public class NLPTrainerJPanel extends javax.swing.JPanel {
    ...
    public NLPTrainerJPanel(JPanel logincontainerJPanel,JPanel container, HealthNGO system) {
        initComponents();
        String networkname="NLP Trainer Login";
        for(Network network:system.getNetworkList()){
            networkname=network.getName()+" "+"NLP Trainer Login";
        }
    ...
    private void initComponents() {
        ...
        loginjPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "NLP Trainer Login Only", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
    ...
    private void loginjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginjButtonActionPerformed
        ...
        if(user==null){
            ...
            boolean isFound=system.getUsersDirectory().checkIfUsernameIsNLPTrainer(user.getRole().toString());
            if(isFound){
                NLPTrainerRoleWorkerjPanel nlpTrainerWorkAreaJPanel=new NLPTrainerRoleWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);
                logincontainerJPanel.setVisible(false);
                container.add("nlpTrainerWorkAreaJPanel",nlpTrainerWorkAreaJPanel);

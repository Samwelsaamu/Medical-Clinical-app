...
public class DonarJPanel extends javax.swing.JPanel {
    ...
    public DonarJPanel(JPanel logincontainerJPanel,JPanel container, HealthNGO system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        loginjPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Donor Login", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        newUserjPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "New Donor Registration", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
    ...
    private void createNewUserjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createNewUserjButtonActionPerformed
        ...
        String message=null;
        if(role.toString().equalsIgnoreCase("Donar")){
            message="Dear, \n"+firstname+" "+lastname+"\n"+
...
//        JOptionPane.showMessageDialog(null, dob);
    ...
    private void loginjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginjButtonActionPerformed
        ...
        if(user==null){
            ...
            boolean isFound=system.getUsersDirectory().checkIfUsernameIsDonar(user.getRole().toString());
            if(isFound){
                DonarWorkerjPanel patientWorkAreaJPanel=new DonarWorkerjPanel(logincontainerJPanel,container,inEnterprise,inDepartment, user ,system);

...
public class AdministrationAssisatanceJPanel extends javax.swing.JPanel {
    ...
    public AdministrationAssisatanceJPanel(JPanel logincontainerJPanel,JPanel container, HealthNGO system) {
        initComponents();
        String networkname="Admin Login";
        for(Network network:system.getNetworkList()){
            networkname=network.getName()+" "+"Admin Login";
        }
    ...
    private void initComponents() {
        ...
        loginjPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Administration Assistance Login Only", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        jLabel3.setText("Login to Configure Users");
    ...
    private void loginjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginjButtonActionPerformed
        ...
        if(user==null){
            ...
            boolean isAdminAssistance=system.getUsersDirectory().checkIfUsernameIsAdminAssistance(user.getRole().toString());
            if(isAdminAssistance){
                AdministrationAssistanceWorkerjPanel adminAssistanceWorkAreaJPanel=new AdministrationAssistanceWorkerjPanel(logincontainerJPanel,container,inEnterprise, user ,system);

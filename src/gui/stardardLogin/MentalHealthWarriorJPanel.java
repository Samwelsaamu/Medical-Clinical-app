...
public class MentalHealthWarriorJPanel extends javax.swing.JPanel {
    ...
    public MentalHealthWarriorJPanel(JPanel logincontainerJPanel,JPanel container, HealthNGO system) {
        initComponents();
        String networkname="Warrior Login";
        for(Network network:system.getNetworkList()){
            networkname=network.getName()+" "+"Warrior Login";
        }
    ...
    private void initComponents() {
        ...
        emergencycontactnamejTextField = new javax.swing.JTextField();
        jLabel16 = new javax.swing.JLabel();
        emergencycontactphonejTextField = new javax.swing.JTextField();
        ...
        newUserjPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "New Warrior Registration", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        jLabel15.setText("Emergency Contact Name");

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel16.setText("Emergency Contact Phone");
            ...
            .addGroup(newUserjPanelLayout.createSequentialGroup()
                .addGroup(newUserjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(newUserjPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(monthjComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    ...
                    .addGroup(newUserjPanelLayout.createSequentialGroup()
                        ...
                        .addGap(6, 6, 6)
                        .addComponent(emergencycontactnamejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(newUserjPanelLayout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(6, 6, 6)
                        .addComponent(emergencycontactphonejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(newUserjPanelLayout.createSequentialGroup()
                        .addGap(10, 10, 10)
        ...
        newUserjPanelLayout.setVerticalGroup(
            ...
            .addGroup(newUserjPanelLayout.createSequentialGroup()
                ...
                .addGroup(newUserjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(emergencycontactnamejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(6, 6, 6)
                .addGroup(newUserjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(emergencycontactphonejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(11, 11, 11)
                .addGroup(newUserjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void createNewUserjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createNewUserjButtonActionPerformed
        ...
        String emergencyphone = this.emergencycontactphonejTextField.getText().trim();
        String emergencyname = this.emergencycontactnamejTextField.getText().trim();
        ...
        int zip;
        Long contactno,emergencyno,ssno;
        Role role = (Role) new MentalHealthWarriorRole();
        String message = null;
//        Department department = new HospitalDepartment();
        
        if(username.isEmpty() || password.isEmpty() || firstname.isEmpty() || lastname.isEmpty() || sex.isEmpty()
                || dob.isEmpty() || mailid.isEmpty() || phone.isEmpty() || emergencyphone.isEmpty() || emergencyname.isEmpty()
        ...
        try{
            ...
            emergencyno=Long.valueOf(emergencyphone);
        }
        catch(Exception ex){
        ...
        if (phone.length()<10 || phone.length()>10 ) {
         ...
         if (emergencyphone.length()<10 || emergencyphone.length()>10 ) {
            JOptionPane.showMessageDialog(this, "Emergency Phone Number Should be 10 digits.", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
...
//        boolean uniquemail=system.checkIfUserMailIsUnique(mailid);
        ...
        if(role.toString().equalsIgnoreCase("Mental Health Warrior")){
            message="Dear, \n"+firstname+" "+lastname+"\n"+
            ...
            Users MHW=system.getUsersDirectory().createUserAccount(username, password, employee, role, firstname, lastname, dob, sex, address, city, state, zip, contactno, mailid, ssno, emergencyno, emergencyname, null, null);
...
//        JOptionPane.showMessageDialog(null, dob);
    ...
    private void loginjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginjButtonActionPerformed
        ...
        if(user==null){
            ...
            boolean isWarrior=system.getUsersDirectory().checkIfUsernameIsWarrior(user.getRole().toString());
            if(isWarrior){
                MentalHealthWorkerjPanel patientWorkAreaJPanel=new MentalHealthWorkerjPanel(logincontainerJPanel,container, user ,system);
...
//        dayjComboBox.removeAll();
    ...
    private javax.swing.JTextField emergencycontactnamejTextField;
    private javax.swing.JTextField emergencycontactphonejTextField;

 ...
 */
package gui.EmergencyMedicineDoctorRole;

import gui.LifelineAgent.LifelineWorkerProcessSuicideRequestjPanel;
...
public class EmergencyMedicineDoctorRoleWorkerjPanel extends javax.swing.JPanel {
    ...
    public EmergencyMedicineDoctorRoleWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
...
//        System.out.println(org);
    ...
    private void initComponents() {
        ...
        mhwLogoutjButton.setBackground(java.awt.SystemColor.window);
        mhwLogoutjButton.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        mhwLogoutjButton.setForeground(java.awt.SystemColor.textHighlight);
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        if(request.getStatus().equals("Sent to Lifeline Agent")){
            request.setStatus("Seen by Lifeline Agent");
        }
        LifelineWorkerProcessSuicideRequestjPanel mhwsuicideIdeationProcess=new LifelineWorkerProcessSuicideRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,request);

...
public class MentalHealthWorkerPharmacyjPanel extends javax.swing.JPanel {
    ...
    public MentalHealthWorkerPharmacyjPanel(JPanel logincontainerJPanel,JPanel container, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
...
//        System.out.println(requests);
        if(requests.contains("Controller.WorkQueue.PrescriptionNotesWorker")){
            ...
            MentalHealthWorkerPrescriptionRequestjPanel mhwsuicideIdeationProcess=new MentalHealthWorkerPrescriptionRequestjPanel(logincontainerJPanel,container, user ,system,request);
            CardLayout layout=(CardLayout)container.getLayout();

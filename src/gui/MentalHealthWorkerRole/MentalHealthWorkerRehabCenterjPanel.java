...
public class MentalHealthWorkerRehabCenterjPanel extends javax.swing.JPanel {
    ...
    public MentalHealthWorkerRehabCenterjPanel(JPanel logincontainerJPanel,JPanel container, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.PatientRequest")){
            ...
            MentalHealthWorkerRehabRequestjPanel mhwRehabProcess=new MentalHealthWorkerRehabRequestjPanel(logincontainerJPanel,container, user ,system,request);
            CardLayout layout=(CardLayout)container.getLayout();

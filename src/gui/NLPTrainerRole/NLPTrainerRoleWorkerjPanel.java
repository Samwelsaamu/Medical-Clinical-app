...
public class NLPTrainerRoleWorkerjPanel extends javax.swing.JPanel {
    ...
    public NLPTrainerRoleWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
        ...
        this.org=(AdministrationDepartment)org;
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Suicide Admission Requests", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));

        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Patient Admitted Assigned to You", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Patient Admitted Not Assigned", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        jScrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder("Talk to Agent Request"));
        ...
        jScrollPane3.setViewportView(rehabCenterRequestsjTable);
    ...
    private void yourAssignedRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_yourAssignedRequestsjTableMouseClicked
        ...
        HospitalAdmissionRequest request = (HospitalAdmissionRequest)yourAssignedRequestsjTable.getValueAt(selectedRow, 0);
//        PatientRequest patientRequest = (PatientRequest)request.getWorkOrderR();
//        System.out.println(patientRequest);
//        SuicideIdeationRequest suicide = (SuicideIdeationRequest)request.getSuidiceIdeation();
//        System.out.println(suicide);
        NLPTrainerRoleWorkerProcessSuicideRequestjPanel nlpProcess=new NLPTrainerRoleWorkerProcessSuicideRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,request);
        CardLayout layout=(CardLayout)container.getLayout();
        container.add("nlpProcess",nlpProcess);
    ...
    private void noneassignedRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_noneassignedRequestsjTableMouseClicked
        ...
        if(confirm==0){
            HospitalAdmissionRequest admissiR=(HospitalAdmissionRequest)noneassignedRequestsjTable.getValueAt(selectedRow, 0);
            admissiR.setReceiver(user);
            user.getWorkQueue().getWorkRequestList().add(admissiR);
            dB4OModel.storeSystem(system);
            displayNoneAssignedRequests();
            displayMyAssignedRequests();
            JOptionPane.showMessageDialog(null, "This Patient is Assigned to You.");
        }      
    ...
    private void rehabCenterRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rehabCenterRequestsjTableMouseClicked
        ...
        PatientRequest request = (PatientRequest)rehabCenterRequestsjTable.getValueAt(selectedRow, 0);
        
        NLPTrainerRoleWorkerProcessTalktoAgentRequestjPanel nlpRehabProcess=new NLPTrainerRoleWorkerProcessTalktoAgentRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,request);
        CardLayout layout=(CardLayout)container.getLayout();
        container.add("nlpRehabProcess",nlpRehabProcess);
        layout.next(container);
    ...
    public void displayNoneAssignedRequests(){
        ...
        for (WorkRequest order : org.getWorkQueue().getWorkRequestList()){
            ...
            if(request.contains("Controller.WorkQueue.HospitalAdmissionRequest")){
    ...
    public void displayMyAssignedRequests(){
        ...
        for (WorkRequest order : user.getWorkQueue().getWorkRequestList()){
            ...
            String request=String.valueOf(order);
            if(request.contains("Controller.WorkQueue.HospitalAdmissionRequest")){
                HospitalAdmissionRequest suicide=((HospitalAdmissionRequest)order);
                row[0] = order;
                row[1] = suicide.getWorkOrderR().getSender().toFullname();
                row[2] = order.getStatus();
                row[3] = order.getMessage();
                row[4] = order.getRequestDate();
                String result = ((HospitalAdmissionRequest)order).getRequesteResult();

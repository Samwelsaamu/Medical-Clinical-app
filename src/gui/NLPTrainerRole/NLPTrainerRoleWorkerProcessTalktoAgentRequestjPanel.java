...
import Controller.WorkQueue.TalkToAgentWorker;
...
public class NLPTrainerRoleWorkerProcessTalktoAgentRequestjPanel extends javax.swing.JPanel {
    ...
    public NLPTrainerRoleWorkerProcessTalktoAgentRequestjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise, Users user, HealthNGO system,PatientRequest patientRequest) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        chatMessagejTextArea = new javax.swing.JTextArea();
        checkConditionButton = new javax.swing.JButton();
        jScrollPane3 = new javax.swing.JScrollPane();
        mhwChatsjTable = new javax.swing.JTable();
        ...
        patientrequestjLabel = new javax.swing.JLabel();
        jLabel11 = new javax.swing.JLabel();
        patientresultLabel = new javax.swing.JLabel();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Chat or Talk", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));

        chatMessagejTextArea.setColumns(20);
        chatMessagejTextArea.setRows(5);
        jScrollPane2.setViewportView(chatMessagejTextArea);

        checkConditionButton.setBackground(new java.awt.Color(204, 255, 204));
        checkConditionButton.setText("Submit Reply");
        ...
        mhwChatsjTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Request", "Sender", "Receiver", "Message", "Status", "Result"
            }
        ));
        jScrollPane3.setViewportView(mhwChatsjTable);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(submitFinaljButton, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(submitFinaljButton, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane3))
        );

        jPanel2.setBackground(new java.awt.Color(0, 153, 153));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Talk to Agent Issue", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        patientrequestjLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        patientrequestjLabel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel11.setText("Result");

        patientresultLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        patientresultLabel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(6, 6, 6)
                        .addComponent(patientrequestjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(6, 6, 6)
                        .addComponent(patientresultLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(patientrequestjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(patientresultLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void checkConditionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkConditionButtonActionPerformed
        String message = chatMessagejTextArea.getText().trim();
        if(message.isEmpty()){
            JOptionPane.showMessageDialog(this, "Please Specify Reply Message", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        int confirm=JOptionPane.showConfirmDialog(null, "Do You Want to Send this Reply?", "Talk to Patient", JOptionPane.YES_NO_OPTION);
        if(confirm!=0){
            return;
        } 
        patientRequest.setStatus("Reply by Agent");
        
        TalkToAgentWorker talkToAgent = new TalkToAgentWorker();
        talkToAgent.setMessage(message);
        talkToAgent.setStatus("Agent Replyed");
        talkToAgent.setSender(user);
        talkToAgent.setReceiver(patientRequest.getSender());
        talkToAgent.setWorkOrderR(patientRequest);
        patientRequest.setTalkToAgentWorker(talkToAgent);
        chatMessagejTextArea.setText("");
        JOptionPane.showMessageDialog(null, "Reply Message Sent.");
    ...
    public void displayPatient(){
        ...
        this.patientrequestjLabel.setText(patientRequest.getMessage());
        if(result==null){
            patientresultLabel.setText("Waiting");
            checkConditionButton.setVisible(true);
            chatMessagejTextArea.setEditable(true);
        }
        else{
            patientresultLabel.setText("Yes");
            checkConditionButton.setVisible(false);
            chatMessagejTextArea.setEditable(false);
            chatMessagejTextArea.setText(result);
        }
    }
    
    public void displayConditionsAndCounsellings(){
        DefaultTableModel model = (DefaultTableModel) mhwChatsjTable.getModel();
        model.setRowCount(0);
        for (TalkToAgentWorker order : patientRequest.getTalkToAgentWorker()){
    ...
    private javax.swing.JTextArea chatMessagejTextArea;
    ...
    private javax.swing.JTable mhwChatsjTable;
    ...
    private javax.swing.JLabel patientrequestjLabel;
    private javax.swing.JLabel patientresultLabel;

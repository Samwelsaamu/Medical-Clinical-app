...
public class LifelineWorkerjPanel extends javax.swing.JPanel {
    ...
    public LifelineWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
...
//        SuicideIdeationRequest suoce = (SuicideIdeationRequest)previousRequestsjTable.getValueAt(selectedRow, 0);
//        JOptionPane.showMessageDialog(null, suoce.getWorkOrderR());

...
public class LifelineWorkerProcessSuicideRequestjPanel extends javax.swing.JPanel {
    ...
    private SuicideIdeationRequest suicideIdeationR=null;
    public LifelineWorkerProcessSuicideRequestjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise, Users user, HealthNGO system,PatientRequest patientRequest) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(networknamejLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Respond to MHW Suicide Issue", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        forwardToHospitaljButton.setText("Forward to Psychiatrist and CCM");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(forwardToHospitaljButton, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(patientnamejLabel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
                    .addComponent(patientstateaddressjLabel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(patientphonejLabel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(patientemailjLabel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(patientdobjLabel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(patientnamejLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(patientstateaddressjLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(patientphonejLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(patientemailjLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(patientdobjLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(patientsexjLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );

        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel1, jLabel2, jLabel3, jLabel4, jLabel5, jLabel6, patientdobjLabel1, patientemailjLabel1, patientnamejLabel1, patientphonejLabel1, patientsexjLabel1, patientstateaddressjLabel1});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LifelineWorkerjPanel dwjp = (LifelineWorkerjPanel) component;
    ...
    private void forwardToHospitaljButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_forwardToHospitaljButtonActionPerformed
        ...
        patientRequest.setStatus("Forwarded to Psychiastrist");
        patientRequest.setRequesteResult("The Patient is Know Reffered to Hospital Psychiatrist");
        suicideIdeationR = new SuicideIdeationRequest();
        suicideIdeationR.setMessage(message);
        suicideIdeationR.setSender(user);
        suicideIdeationR.setStatus("Forwarded to Psychiastrist");
        suicideIdeationR.setWorkOrderR(patientRequest);
        user.setStatus("None");
        patientRequest.setSuidiceIdeation(suicideIdeationR);
        for(Network network:system.getNetworkList()){
            for(Enterprise enterprises:network.getEnterpriseDirectory().getEnterpriseList()){
                ...
                for(Department depart : enterprises.getDepartmentDirectory().getDepartmentList()){
                    if (depart instanceof CriticalCareDepartment){
                        criticalcareOrg = depart;
                        break;
                    }
                }
            }
        ...
        if(criticalcareOrg==null){
            JOptionPane.showMessageDialog(null, "Could Not Forward to CCM");
            return;
        }
        hospitalOrg.getWorkQueue().getWorkRequestList().add(suicideIdeationR);
        criticalcareOrg.getWorkQueue().getWorkRequestList().add(suicideIdeationR);
        //ccm assigns WO to Emergency vehicle driver to take patient to hosp.
        hospitalOrg.getWorkQueue().getWorkRequestList().add(patientRequest);
        criticalcareOrg.getWorkQueue().getWorkRequestList().add(patientRequest);
//        user.getWorkQueue().getWorkRequestList().add(suicideIdeationR);
    ...
    public void displayPatient(){
        ...
        this.requestIssuejTextArea.setText(patientRequest.getMessage());
        if(suicideIdeationR==null){
            JOptionPane.showMessageDialog(null, "Suicide Ideation has not been Forwarded");
        }
        else{
            this.suicideIssuejTextArea.setText(suicideIdeationR.getMessage());
            this.forwardToHospitaljButton.setVisible(false);
            suicideIssuejTextArea.setEditable(false);
            JOptionPane.showMessageDialog(null, "This Suicide Ideation has been Forwarded");
        }
    }

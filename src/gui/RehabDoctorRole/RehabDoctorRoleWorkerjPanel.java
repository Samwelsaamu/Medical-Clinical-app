...
public class RehabDoctorRoleWorkerjPanel extends javax.swing.JPanel {
    ...
    public RehabDoctorRoleWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
        ...
        this.org=(RehabCenterDepartment)org;
    ...
    private void initComponents() {
        ...
        mhwLogoutjButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 204, 204)));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Rehab Center Issues Requested bt MHW", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.PatientRequest")){
            PatientRequest rehab=(PatientRequest)previousRequestsjTable.getValueAt(selectedRow, 0);
            RehabDoctorWorkerProcessRehabRequestjPanel docRehabProcess=new RehabDoctorWorkerProcessRehabRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,rehab);
    ...
    private void noneassignedRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_noneassignedRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.PatientRequest")){
            int confirm=JOptionPane.showConfirmDialog(null, "Assign Rehab Center Issue To You?", "Assign Rehab Center Issue Confirmation", JOptionPane.YES_NO_OPTION);
            if(confirm==0){
                PatientRequest addiction=(PatientRequest)noneassignedRequestsjTable.getValueAt(selectedRow, 0);
                String rec=(addiction.getReceiver()!=null)?addiction.getReceiver().toString():"";
                if(rec.equals("")){
                    addiction.setReceiver(user);
                    addiction.setStatus("Received by Doctor");
                }
                else{
                    addiction.setStatus("Received by Another Doctor");
                }

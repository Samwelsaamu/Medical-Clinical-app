...
public class EmergencyVehicleDriverRoleWorkerjPanel extends javax.swing.JPanel {
    ...
    public EmergencyVehicleDriverRoleWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
        ...
        this.org=(EmergencyDepartment)org;
//        System.out.println(org);
    ...
    private void yourAssignedRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_yourAssignedRequestsjTableMouseClicked
        ...
        EmergencyVehicleDriverRoleWorkerProcessSuicideRequestjPanel emergencyVehicleDriProcess=new EmergencyVehicleDriverRoleWorkerProcessSuicideRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,request);
        CardLayout layout=(CardLayout)container.getLayout();
        container.add("emergencyVehicleDriProcess",emergencyVehicleDriProcess);
    ...
    private void noneassignedRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_noneassignedRequestsjTableMouseClicked
        ...
        if(confirm==0){
            ...
            displayNoneAssignedRequests();
            displayMyAssignedRequests();
            JOptionPane.showMessageDialog(null, "This Patient is Now for you to pick.");
        }      

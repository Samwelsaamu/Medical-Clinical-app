...
public class HelpDeskAgentWorkerProcessAddictionRequestjPanel extends javax.swing.JPanel {
    ...
    public HelpDeskAgentWorkerProcessAddictionRequestjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise, Users user, HealthNGO system,PatientRequest patientRequest) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        forwardToHospitaljButton.setText("Forward to Psychiatrist ");
    ...
    private void forwardToHospitaljButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_forwardToHospitaljButtonActionPerformed
        int confirm=JOptionPane.showConfirmDialog(null, "Do You Want to Route this Addiction Issue to Hospital Psychriatrist?", "Forward Addiction Issue", JOptionPane.YES_NO_OPTION);
        if(confirm==0){
            patientRequest.setStatus("Forwarded to Psychiastrist");
            patientRequest.setRequesteResult("The Patient addiction issue is now under Doctors");
    ...
    public void displayPatient(){
        ...
        if(AddictionStatus.equals("Addiction Sent")){

...
public class CriticalCareManagerWorkerProcessSuicideRequestjPanel extends javax.swing.JPanel {
    ...
    public CriticalCareManagerWorkerProcessSuicideRequestjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise, Users user, HealthNGO system,SuicideIdeationRequest suicideIdeationR) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Send Patient to Hospital through Emergency Vehicle Driver", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        admitPatientjButton.setText("Send Admission Request to Emergency Vehicle Driver");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(admitPatientjButton, javax.swing.GroupLayout.PREFERRED_SIZE, 499, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(admitPatientjButton, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CriticalCareManagerRoleWorkerjPanel dwjp = (CriticalCareManagerRoleWorkerjPanel) component;
    ...
    private void admitPatientjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_admitPatientjButtonActionPerformed
        ...
        if(message.isEmpty()){
            JOptionPane.showMessageDialog(this, "Please Specify Admission Note", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        int confirm=JOptionPane.showConfirmDialog(null, "Do You Want this Patient to be Picked by Emergency Vehicle Dri for Admission?", "Admit Patient", JOptionPane.YES_NO_OPTION);
        if(confirm==0){
            patientRequest.setStatus("Ready for Pickup");
            admission = new HospitalAdmissionRequest();
            admission.setMessage(message);
            admission.setSender(user);
            admission.setStatus("Ready for Pickup");
            admission.setWorkOrderR(patientRequest);
            admission.setSuidiceIdeation(suicideIdeationR);
            patientRequest.setHospAdmissionRequest(admission);
            suicideIdeationR.setHospAdmissionRequest(admission);
            ...
            for(Network network:system.getNetworkList()){
                for(Enterprise enterprises:network.getEnterpriseDirectory().getEnterpriseList()){
                    ...
                    for(Department depart : enterprises.getDepartmentDirectory().getDepartmentList()){
                        if (depart instanceof EmergencyDepartment){
                            emergencyOrg = depart;
                            break;
                        }
                    }
            ...
            if(emergencyOrg==null){
                JOptionPane.showMessageDialog(null, "Emergency Vehicle Driver Not Notified");
                return;
            }
            
            hospitalOrg.getWorkQueue().getWorkRequestList().add(admission);
            patientCareOrg.getWorkQueue().getWorkRequestList().add(admission);
            adminsitrativeOrg.getWorkQueue().getWorkRequestList().add(admission);
            emergencyOrg.getWorkQueue().getWorkRequestList().add(admission);

            admissionNotejTextArea.setText("");
            admissionNotejTextArea.setEditable(false);
            admitPatientjButton.setVisible(false);
            JOptionPane.showMessageDialog(null, "Patient will be picked to be Admitted.");
    ...
    public void displayPatient(){
        ...
        if(this.admission==null){
            ...
            if(admission.getStatus().contains("Ready for Pickup")){
                ...
                admissionNotejTextArea.setText(admission.getMessage());
                admitPatientjButton.setVisible(false);
                admissionNotejTextArea.setEditable(false);
            }

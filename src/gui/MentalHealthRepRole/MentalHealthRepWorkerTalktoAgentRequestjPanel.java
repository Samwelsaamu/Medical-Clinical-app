...
public class MentalHealthRepWorkerTalktoAgentRequestjPanel extends javax.swing.JPanel {
    ...
    public MentalHealthRepWorkerTalktoAgentRequestjPanel(JPanel logincontainerJPanel,JPanel container, Users user, HealthNGO system,PatientRequest patientRequest) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        submitChatjButton.setBackground(new java.awt.Color(255, 255, 204));
        ...
        jScrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Talk to Agent Chats", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        MentalHealthRepWorkerTalktoAgentjPanel dwjp = (MentalHealthRepWorkerTalktoAgentjPanel) component;
    ...
    private void submitChatjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitChatjButtonActionPerformed
        ...
        if(message.isEmpty()){
            JOptionPane.showMessageDialog(this, "Please Talk Message is Required", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        int confirm=JOptionPane.showConfirmDialog(null, "Do You Want to Send This Talk Message?", "Submit Talk Message", JOptionPane.YES_NO_OPTION);
        if(confirm==0){
            patientRequest.setStatus("MHW Sent");
            TalkToAgentWorker talkToAgent = new TalkToAgentWorker();
            talkToAgent.setMessage(message);
            talkToAgent.setStatus("MHW Sent");
            ...
            JOptionPane.showMessageDialog(null, "Talk Message Sent.");

...
public class MentalHealthRepWorkerAddNewMHWjPanel extends javax.swing.JPanel {
    ...
    public MentalHealthRepWorkerAddNewMHWjPanel(JPanel logincontainerJPanel,JPanel container, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
            ...
            .addGroup(newUserjPanelLayout.createSequentialGroup()
                .addGroup(newUserjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(newUserjPanelLayout.createSequentialGroup()
                        ...
                        .addGap(6, 6, 6)
                        .addComponent(relationjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        newUserjPanelLayout.setVerticalGroup(
            ...
            .addGroup(newUserjPanelLayout.createSequentialGroup()
                ...
                .addGroup(newUserjPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(relationjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(2, 2, 2)
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        MentalHealthRepWorkerjPanel dwjp = (MentalHealthRepWorkerjPanel) component;
        dwjp.yourMHWs();
    ...
    private void createNewUserjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createNewUserjButtonActionPerformed
        ...
        String relation=relationjTextField.getText().trim();
        int zip;
        ...
        if(role.toString().equalsIgnoreCase("Mental Health Warrior")){
            message="Dear, \n"+firstname+" "+lastname+"\n"+
            "Your are now Registered with us by "+user.toFullname()+".\n" +
...
//            }
            ...
            {
                MHW.setRelation(relation);
                MHW.setMHWR(user);
                this.newUserjPanel.setVisible(false);
                JOptionPane.showMessageDialog(null, "MHW Details Submmited Successfully. Account Created.");

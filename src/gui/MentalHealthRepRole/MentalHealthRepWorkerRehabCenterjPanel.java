...
public class MentalHealthRepWorkerRehabCenterjPanel extends javax.swing.JPanel {
    ...
    public MentalHealthRepWorkerRehabCenterjPanel(JPanel logincontainerJPanel,JPanel container, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        issueTypejComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rehab Alcohol Addiction", "Rehab Substance Abuse" }));

        jButton1.setBackground(new java.awt.Color(204, 255, 204));
        jButton1.setText("Submit Issue Request");
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.PatientRequest")){
            ...
            MentalHealthRepWorkerRehabRequestjPanel mhwRehabProcess=new MentalHealthRepWorkerRehabRequestjPanel(logincontainerJPanel,container, user ,system,request);
            CardLayout layout=(CardLayout)container.getLayout();
            container.add("mhwRehabProcess",mhwRehabProcess);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int confirm=JOptionPane.showConfirmDialog(null, "Rehab  Center Chat Request?", "Rehab Center Request", JOptionPane.YES_NO_OPTION);
        if(confirm==0){
        PatientRequest request = new PatientRequest();
        request.setMessage(message);
        request.setSender(user);
        request.setStatus("Rehab Center Request");
        ...
        JOptionPane.showMessageDialog(null, "Rehab Center Chat Request Submitted.\nA Please Wait for responses.");

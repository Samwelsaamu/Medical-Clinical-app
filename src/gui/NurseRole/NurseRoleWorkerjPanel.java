...
public class NurseRoleWorkerjPanel extends javax.swing.JPanel {
    ...
    public NurseRoleWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
        ...
        this.org=(PatientCareDepartment)org;
    ...
    private void yourAssignedRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_yourAssignedRequestsjTableMouseClicked
        ...
        NurseWorkerProcessSuicideRequestjPanel nurseProcess=new NurseWorkerProcessSuicideRequestjPanel(logincontainerJPanel,container,enterprise, user ,system,request);
        CardLayout layout=(CardLayout)container.getLayout();
        container.add("nurseProcess",nurseProcess);

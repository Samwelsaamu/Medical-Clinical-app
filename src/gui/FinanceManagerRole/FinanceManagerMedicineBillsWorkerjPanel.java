...
public class FinanceManagerMedicineBillsWorkerjPanel extends javax.swing.JPanel {
    ...
    public FinanceManagerMedicineBillsWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(loggedmhwjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 543, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        BillingWorker request =(BillingWorker)previousRequestsjTable.getValueAt(selectedRow, 0);
        
        FinanceManagerWorkerPrescriptionBilljPanel financeMedicineBill=new FinanceManagerWorkerPrescriptionBilljPanel(logincontainerJPanel,container, user ,system,request);
        CardLayout layout=(CardLayout)container.getLayout();
        container.add("financeMedicineBill",financeMedicineBill);
    ...
    public void previousRequets(){
        ...
        for (WorkRequest order : org.getWorkQueue().getWorkRequestList()){
            ...
            if(request.contains("Controller.WorkQueue.BillingWorker")){
                row[0] = order;
                row[1] = ((BillingWorker)order).getWorkOrderR().getSender().toFullname();
                row[2] = (order.getSender()!=null)?order.getSender():"";
                String result = ((BillingWorker)order).getRequesteResult();

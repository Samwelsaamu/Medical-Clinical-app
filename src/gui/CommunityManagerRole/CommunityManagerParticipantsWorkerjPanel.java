...
public class CommunityManagerParticipantsWorkerjPanel extends javax.swing.JPanel {
    ...
    public CommunityManagerParticipantsWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Participants", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
        ...
        enterprisessjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Participant", "Fullname", "Email", "Phone", "DOB", "SSN"
            }
        ));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Events for Participants", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
    ...
    private void enterprisessjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enterprisessjTableMouseClicked
       int selectedRow = enterprisessjTable.getSelectedRow();
        if (selectedRow < 0){
            JOptionPane.showMessageDialog(null, "Please Select Participant.");
            
            return;
        }
        Users participant = (Users)enterprisessjTable.getValueAt(selectedRow, 0);
        ...
        for (EventsParticipant eventParticipated : system.getEventParticipantDirectory().getEventsParticipantList()){
            ...
            if(rec.equals("") || (eventParticipated.getParticipant()==participant)){
                eventParticipatedStr+=sno+". "+eventParticipated.getEvent()+" "+eventParticipated.getEvent().getDate()+" "+eventParticipated.getEvent().getTime()+"\n\n";
                sno++;
            }
        }
    ...
    private void displayDonations(){
        ...
        model.setRowCount(0);
        for (Users participant : system.getUsersDirectory().getUsersList()){
            Object[] row = new Object[6];
            if(participant.getRole() instanceof CommunityEventsParticipantsRole){
                row[0] = participant;
                row[1] = participant.toFullname();
                row[2] = participant.getMailId();
                row[3] = participant.getPhone();
                row[4] = participant.getDob();
                row[5] = participant.getSsnno();
                model.addRow(row);
            }
        }
    }

...
public class DrugDeliveryWorkerjPanel extends javax.swing.JPanel {
    ...
    public DrugDeliveryWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Drugs to Deliver", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));
    ...
    private void previousRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_previousRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.PatientMedicineRequest")){
            ...
            DrugDeliveryWorkerPrescriptionRequestjPanel medicineRProcess=new DrugDeliveryWorkerPrescriptionRequestjPanel(logincontainerJPanel,container, user ,system,request);
    ...
    public void displayPrescriptions(){
        ...
        for (WorkRequest order : org.getWorkQueue().getWorkRequestList()){
            ...
            if(request.contains("Controller.WorkQueue.PatientMedicineRequest")){
                if(order.getStatus().contains("Forwarded to DDA and Billing Agent")){
                    row[0] = order;

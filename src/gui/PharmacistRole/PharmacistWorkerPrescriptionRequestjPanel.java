...
import gui.MentalHealthWorkerRole.*;
import Controller.DB4OModel.DB4OModel;
import Controller.Department.Department;
import Controller.Department.PharmacyBillingDepartment;
...
public class PharmacistWorkerPrescriptionRequestjPanel extends javax.swing.JPanel {
    ...
    public PharmacistWorkerPrescriptionRequestjPanel(JPanel logincontainerJPanel,JPanel container, Users user, HealthNGO system,PatientMedicineRequest patientMedicines) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        forwardToHospitaljButton.setText("Forward to Drug Delivery agent and Billing ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PharmacistWorkerjPanel dwjp = (PharmacistWorkerjPanel) component;
    ...
    private void forwardToHospitaljButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_forwardToHospitaljButtonActionPerformed
        ...
        if(confirm==0){
            patientRequest.setStatus("Forwarded to DDA and Billing Agent");
            patientRequest.setRequesteResult("Prescription is sent to Drug Delivery Agent");
            patientMedicines.setStatus("Forwarded to DDA and Billing Agent");
            patientMedicines.setRequesteResult("Prescription is sent to Drug Delivery Agent");
            prescriptionNotesW.setRequesteResult("Prescription is sent to Drug Delivery Agent");
            prescriptionNotesW.setStatus("Forwarded to DDA and Billing Agent");
            for(Network network:system.getNetworkList()){
                for(Enterprise enterprises:network.getEnterpriseDirectory().getEnterpriseList()){
                    for(Department depart : enterprises.getDepartmentDirectory().getDepartmentList()){
                        if (depart instanceof PharmacyBillingDepartment){
                            pharmacybillingOrg = depart;
                            break;
                        }
                    }
                }
            ...
            if(pharmacybillingOrg==null){
                JOptionPane.showMessageDialog(null, "Could Not Forward to Psychristrist");
                return;
            }

            pharmacybillingOrg.getWorkQueue().getWorkRequestList().add(patientMedicines);
    ...
    public void displayPatient(){
        ...
        if(prescriptionNotesW.getStatus().contains("Forwarded to Pharmacy")){
            forwardToHospitaljButton.setVisible(true);
        }
    }

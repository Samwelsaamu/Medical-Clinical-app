...
public class ITAdminWorkerjPanel extends javax.swing.JPanel {
    ...
    public ITAdminWorkerjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise,Department org, Users user, HealthNGO system) {
        initComponents();
        this.system=system;
    ...
    private void fundsRequestsjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fundsRequestsjTableMouseClicked
        ...
        if(requests.contains("Controller.WorkQueue.SupportTicketRequestWorker")){
            ...
            ITAdminWorkerTicketsjPanel ticketProcess=new ITAdminWorkerTicketsjPanel(logincontainerJPanel,container,enterprise, user ,system,funds);

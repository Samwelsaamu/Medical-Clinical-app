...
public class ITAdminWorkerTicketsjPanel extends javax.swing.JPanel {
    ...
    private SupportTicketRequestWorker ticketRequest;
    public ITAdminWorkerTicketsjPanel(JPanel logincontainerJPanel,JPanel container,Enterprise enterprise, Users user, HealthNGO system,SupportTicketRequestWorker ticketRequest) {
        initComponents();
        this.system=system;
    ...
    private void initComponents() {
        ...
        ticketResultjTextArea = new javax.swing.JTextArea();
        submitjButton = new javax.swing.JButton();
        forwardtoWebsiteManagerjButton = new javax.swing.JButton();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        ticketMessagejTextArea = new javax.swing.JTextArea();
        jLabel1 = new javax.swing.JLabel();
        ticketSenderjLabel = new javax.swing.JLabel();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Ticket Replys", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP));

        ticketResultjTextArea.setColumns(20);
        ticketResultjTextArea.setRows(5);
        jScrollPane2.setViewportView(ticketResultjTextArea);

        submitjButton.setBackground(new java.awt.Color(204, 255, 204));
        submitjButton.setText("Submit Ticket Result");
        ...
        forwardtoWebsiteManagerjButton.setBackground(new java.awt.Color(204, 255, 204));
        forwardtoWebsiteManagerjButton.setText("Forward to Website Manager");
        forwardtoWebsiteManagerjButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 153)));
        forwardtoWebsiteManagerjButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                forwardtoWebsiteManagerjButtonActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(forwardtoWebsiteManagerjButton, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(forwardtoWebsiteManagerjButton, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Ticket Message"));

        ticketMessagejTextArea.setEditable(false);
        ticketMessagejTextArea.setColumns(20);
        ticketMessagejTextArea.setRows(5);
        ticketMessagejTextArea.setEnabled(false);
        jScrollPane1.setViewportView(ticketMessagejTextArea);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel1.setText("Sender");

        ticketSenderjLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ticketSenderjLabel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(itemsstatusLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 413, Short.MAX_VALUE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ticketSenderjLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ticketSenderjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ITAdminWorkerjPanel dwjp = (ITAdminWorkerjPanel) component;
    ...
    private void submitjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitjButtonActionPerformed
        String message = ticketResultjTextArea.getText().trim();
        if(message.isEmpty()){
            JOptionPane.showMessageDialog(this, "Please Specify Result", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        int confirm=JOptionPane.showConfirmDialog(null, "Do You Want to Submit this Ticket Request Result?", "Submit Ticket Request", JOptionPane.YES_NO_OPTION);
        if(confirm==0){
            ticketRequest.setRequesteResult(message);
            ticketRequest.setStatus("Ticket Processed");
            ticketRequest.setReceiver(user);
            ticketResultjTextArea.setText("");
            ticketResultjTextArea.setVisible(false);
            submitjButton.setVisible(false);
            forwardtoWebsiteManagerjButton.setVisible(true);
            JOptionPane.showMessageDialog(null, "This ticket has been Solved.");
            dB4OModel.storeSystem(system);
            displayTicketRequest();
        }      
    }//GEN-LAST:event_submitjButtonActionPerformed

    private void forwardtoWebsiteManagerjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_forwardtoWebsiteManagerjButtonActionPerformed
        ...
        if(confirm==0){
            ticketRequest.setStatus("Forwarded to Website Manager");
            ...
            if(itOrg==null){
                JOptionPane.showMessageDialog(null, "Could Not Forward to Website Manager");
                return;
            }

//            itOrg.getWorkQueue().getWorkRequestList().add(ticketRequest);
            dB4OModel.storeSystem(system);
        }
    }//GEN-LAST:event_forwardtoWebsiteManagerjButtonActionPerformed
    
    public void displayTicketRequest(){
        this.ticketSenderjLabel.setText(String.valueOf(ticketRequest.getSender()));
        this.itemsstatusLabel.setText(ticketRequest.getStatus());
        this.ticketMessagejTextArea.setText(ticketRequest.getMessage());
        if(this.ticketRequest.getRequesteResult()!=null){
            ticketResultjTextArea.setText(ticketRequest.getRequesteResult());
            ticketResultjTextArea.setEditable(false);
            submitjButton.setVisible(false);
            forwardtoWebsiteManagerjButton.setVisible(false);
        }
        else{
            ticketResultjTextArea.setText("");
            ticketResultjTextArea.setEditable(true);
    ...
    private javax.swing.JButton forwardtoWebsiteManagerjButton;
    ...
    private javax.swing.JTextArea ticketMessagejTextArea;
    private javax.swing.JTextArea ticketResultjTextArea;
    private javax.swing.JLabel ticketSenderjLabel;
